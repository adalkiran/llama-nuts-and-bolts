...
GITHUB_URL="https://github.com/adalkiran/llama-nuts-and-bolts"
...
for file in ./docs/*.md; do
    ...
    # Convert LaTEX sections to Hugo format
    #sed -i -e ':a;N;$!ba; s/\$\$\([^$$]*\)\$\$/{{< katex display=true class="optional" >}}\1{{< \/katex >}}/g; ta' "$file"
