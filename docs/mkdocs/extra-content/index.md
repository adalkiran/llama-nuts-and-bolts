...
* Loading a [SentencePiece (SPM)](https://github.com/google/sentencepiece) tokenizer model file ("tokenizer.model") which was saved as [Protocol Buffers (Protobuf)](https://protobuf.dev/) format, from scratch, see [Chapter 5](05-LOADING-TOKENIZER-MODEL.md) and  see [Chapter 6](06-LOADING-TOKENIZER-MODEL-DETAILS.md),
...
* Building the blocks of LLaMa 2 model architecture, see [Chapter 9](09-IMPLEMENTING-LLAMA-MODEL-ARCHITECTURE.md),
